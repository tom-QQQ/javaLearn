...
/**
 * Created by luogang on 2019/6/27.
 */
public class DateUtils {
     ...
     * @param  sFormat�?日期格式字符�?
     * @return String�?转换成指定格式的字符串形�?
     */
    ...
    /**
     * 根据日期获取 年周   如：2014-01-07  =�?2014年第2�?
     * @param date
     * @return *年第*�?     2014年第2�?
     * @throws ParseException
     */
    public static String getWeekOfYear(String date) throws ParseException {
        ...
        String weekOfYear = calendar.get(Calendar.YEAR)+"年第"+calendar.get(Calendar.WEEK_OF_YEAR)+"�?";
        return weekOfYear;
    }

    /**
     * 根据日期获取 星期�? 如：2014-05-05  =�?2014-05-11
     * @param date
     * @return
     * @throws ParseException
     */
    public static String getSunday(String date) throws ParseException {
        ...
        cal.setTime(d_date);
        cal.set(Calendar.DAY_OF_WEEK, Calendar.SUNDAY); // 获取本周�?的日�?
        String str_date = df.format(cal.getTime());
        return str_date;
    }

    /**
     * 根据日期获取 星期�? 如：2014-04-16  =�?2014-04-14
     * @param date
     * @return
     * @throws ParseException
     */
    ...
    /**
     * 根据日期获取上一�? 星期�? 如：2014-04-09  =�?2014-03-31
     * @param date
     * @return
     * @throws ParseException
     */
    ...
    /**
     * 根据日期获取下一�? 星期�? 如：2014-04-09  =�?2014-04-20
     * @param date
     * @return
     * @throws ParseException
     */
    ...
    /**
     * 判断是否相距超过10�?   isOverDistanceWeek("2014-02-23","2014-04-27",10)= false;isOverDistanceWeek("2014-02-16","2014-04-27",10)= true;
     * true 表示超过count�?     ；false 表示没有超过
     * @param beginDate
     * @param endDate
     * @param count
     * @return
